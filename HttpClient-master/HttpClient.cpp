...
void HttpClient::request(http_request_t &aRequest, http_response_t &aResponse, http_header_t headers[], const char* aHttpMethod)
{
    ...
    int bodyPos = raw_response.indexOf("Date");
    if (bodyPos == -1) {
        #ifdef LOGGING
    ...
    aResponse.body = "" + raw_response.substring(bodyPos);
    int startPos = aResponse.body.indexOf(" ");
    int endPos = aResponse.body.indexOf("\n");
    aResponse.body = "" + aResponse.body.substring(startPos+1,endPos);
